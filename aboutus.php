...
<body>
    ...
    <div id="menu">
        <ul>
            ...
            <li class="active"><a href="aboutus.php" accesskey="5" title="">About Us</a></li>
    ...
    <div id="page">
        <div id="content">
            ...
            <div class="box">
                <p>There are many types of flowers in the world. It is quite possible to reach these flowers with the "Be Flower" team. Do not think about what you will buy for your loved one for special occasions. We are here now!</p>


                <p> If you want to have the flower you want with just one click, you are in the right place. Order the flower you want and we'll send it to your loved one on your desired day.</p>
