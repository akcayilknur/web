...
<body>
    ...
    <div class="main">
        ...
        <div class="row">
            ...
            <div class="column">
                <div class="content">
                    <img src="teraryum/t1.png" alt="Lights" style="width:100%">
                    <h3>Love of music</h3>
                    <center><button onclick="window.location.href = 'PC-terrarium-1.php';">Browse</button></center>
                </div>
            </div>

            <div class="column">
                <div class="content">
                    <img src="teraryum/t2.png" alt="Nature" style="width:100%">
                    <h3>Summerday</h3>
            ...
            <div class="column">
                <div class="content">
                    <img src="teraryum/t3.png" alt="Mountains" style="width:100%">
                    <h3>Foundation of justice</h3>
                    <center><button onclick="window.location.href = 'https://www.google.com';">Browse</button></center>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="column">
                <div class="content">
                    <img src="teraryum/t4.png" alt="Lights" style="width:100%">
                    <h3>Summer dairy</h3>
                    <center><button onclick="window.location.href = 'https://www.google.com';">Browse</button></center>
                </div>
            </div>
            ...
            <div class="column">
                <div class="content">
                    <img src="teraryum/t5.png" alt="Nature" style="width:100%">
                    <h3>Perfect teacher</h3>
                    <center><button onclick="window.location.href = 'https://www.google.com';">Browse</button></center>
                </div>
            </div>
            ...
            <div class="column">
                <div class="content">
                    <img src="teraryum/t6.png" alt="Mountains" style="width:100%">
                    <h3>Pretty day</h3>
                    <center><button onclick="window.location.href = 'https://www.google.com';">Browse</button></center>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="column">
                <div class="content">
                    <img src="teraryum/t7.png" alt="Lights" style="width:100%">
                    <h3>Magic wedding</h3>
                    <center><button onclick="window.location.href = 'https://www.google.com';">Browse</button></center>
                </div>
            </div>
            ...
            <div class="column">
                <div class="content">
                    <img src="teraryum/t8.png" alt="Nature" style="width:100%">
                    <h3> Caravan moment </h3>
                    <center><button onclick="window.location.href = 'https://www.google.com';">Browse</button></center>
                </div>
            </div>
            ...
            <div class="column">
                <div class="content">
                    <img src="teraryum/t9.png" alt="Mountains" style="width:100%">
                    <h3>Family is perfect</h3>
                    <center><button onclick="window.location.href = 'https://www.google.com';">Browse</button></center>
                </div>
            </div>
